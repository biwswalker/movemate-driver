...
const styles = StyleSheet.create({
  ...
  contentWrapper: { marginTop: normalize(48), gap: normalize(12) },
  inputWrapper: { paddingHorizontal: normalize(16) },
  actionWrapper: { paddingVertical: normalize(32) },
  formSubtitle: { paddingTop: normalize(32), paddingLeft: 8 },
  helperText: { marginTop: normalize(8), paddingLeft: normalize(12) },
  inputWrapperColumn: { flexDirection: "row", gap: normalize(8) },
});
